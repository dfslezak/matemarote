...
urlpatterns += patterns('',
    ...
    url(r'^gamelogger/new_play_session/$', 'gamelogger.views.new_play_session'),
    url(r'^gamelogger/log_entry/$', 'gamelogger.views.log_action'),
...
urlpatterns += patterns('',
    ...
    url(r'^gameflow/(?P<gameflow_node>.*)/$', 'web_frontend.views.serve_game'),
    ...
    url(r'^gameflow/(?P<gameflow_node>.*)/res/(?P<resource_path>.*)',
        'web_frontend.views.serve_game_resource', name="serve_game_static"),
    url(r'^gameflow/(?P<gameflow_node>.*)/game_file/(?P<game_file_path>.*)',
